...
idx_150_300  = (f >= 150 & f <= 300);
idx_300_1500 = (f > 300 & f <= 1500);
a_hre_f(idx_150_300)  = 8.29*(log10(1.54*hre))^2 - 1.1;
a_hre_f(idx_300_1500) = 3.2*(log10(11.75*hre))^2 - 4.97;
